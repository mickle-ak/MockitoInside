...
public final class TypeUtils {
	...
	private static final Map<Class<?>, @Nullable Object> DEFAULTS_AS_VALUES  = new HashMap<>();
	...
	public static <T> @Nullable T getDefaultValue( Class<T> clazz ) {
	...
	private static <T> void putValue( Class<T> clazz, @Nullable T defaultValue ) {
